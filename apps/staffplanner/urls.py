...
from apps.staffplanner.views import set_staffplanner_dates, set_staffplanner_minimum_per_shift, management_headcount_planning_view, management_role_planning_view, toggle_shift
from datetime import date

urlpatterns = [
    path('set-minimum-per-shift/', set_staffplanner_minimum_per_shift, name='set_staffplanner_minimum_per_shift'),
